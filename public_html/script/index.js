...
$(window).ready(function(){
  ...
  function move(newIndex) {
    ...
    bulletArray[currentIndex].removeClass('tic-active');
    bulletArray[newIndex].addClass('tic-active');
  ...
  $.each($slides, function(index) {
    var $button = $('<div class="slide_btn tic-point"></div>');
    
    if (index === currentIndex) {
      $button.addClass('tic-active');
    }
